...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{circuitikz}                     % Required for circuits
\usepackage{cancel}                         % Required for including pictures
\usepackage{booktabs}
\usepackage{xcolor}
\usepackage{colortbl}
\usepackage{float}
\usepackage{siunitx}                        % For scientific notation
\usepackage{amsmath}                        % For \boxed equations inside math environments
\usepackage{mathtools}                      % For \Aboxed equations inside \align environment
\usepackage{relsize}                        % For changing the size of equations
\usepackage{graphicx}[pdftex]               % Required for including pictures
...
\definecolor{blue}{RGB}{243,102,25}         % Define the orange color used for highlighting throughout the book
...
\usepackage{csquotes} % Ensure that quoted texts are typeset according to the rules of your main language
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\titlecontents{chapter}
	...
	{\color{blue}\contentslabel[\Large\thecontentslabel]{1.25cm}\color{blue}} % Formatting of numbered sections of this type
...
%                                          THEOREM STYLES                                                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{amsmath,amsfonts,amssymb,amsthm,cancel} % For math equations, theorems, symbols, etc
...
\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=2pt,rounded corners=15pt,draw=blue,fill=white,fill opacity=0.5,inner sep=15pt,minimum height=1.2\chaptertitleheight]{\strut\makebox[22cm]{}};
